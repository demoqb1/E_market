                    ...
                    <div class="container-fluid">
                        <div id="cat-1" class="category-section">
                            <div class="category-title">
                                <div class="dropdown" >
                                    <a href="#" class="dropdown-toggle cat-title" data-display="static" data-toggle="dropdown">Sản Phẩm Nổi Bật<i class="fa fa-angle-down"></i></a>
                                   
                                </div><!-- End .dropdown -->
                                <a href="{{route('showhotpro')}}" class="btn btn-outline-primary">Xem nhiều hơn</a>
                        ...
                        <div id="cat-2" class="category-section">
                            <div class="category-title">
                                <div class="cat-title">Sản Phẩm Đang Giảm Giá</div>
                                <a href="#" class="btn btn-outline-primary">Xem nhiều hơn</a>
                            </div><!-- End .category-title -->

                            <div class="products-carousel owl-carousel owl-theme">
                                @foreach($sale_pro as $pro)
                                <div class="product">
                                    <figure class="product-image-container">
                                        <a href="{{route('productDetail',[$pro->slug,$pro->id])}}" class="product-image">
                                    ...
                                    <div class="product-details">
                                      ...
                                      @if($pro->sale_price>0)
                                       ...
                                       @else
                                        ...
                                        <div class="product-action">
                                            <a href="#" class="paction add-wishlist" title="Thêm vào ưa thích">
                        ...
                        <div id="cat-3" class="category-section">
                            <div class="category-title">
                                <div class="cat-title">Sản Phẩm Mới</div>
                                <a href="#" class="btn btn-outline-primary">Xem nhiều hơn</a>
                            </div><!-- End .category-title -->
