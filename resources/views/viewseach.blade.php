            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container-fluid ">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('productAll')}}">Danh sách sản phẩm</a></li>
                    </ol>
                    ...
                    <div class="container-fluid">
                        <nav class="toolbox">
                            ...
                            <div class="toolbox-item toolbox-show">
                                <label>Tìm thấy {{count($product)}} sản phẩm</label>
                                    ...
                                    <div class="product-details">
                                       ...
                                       @else
                                        ...
                                        <div class="product-action">
                                            ...
                                            <a href="{{route('productDetail',[$pro->slug,$pro->id])}}" class="paction add-cart" title="Thêm vào giỏ hàng">
                        ...
                        <nav class="toolbox toolbox-pagination">
                            <div class="toolbox-item toolbox-show">
                                <label>Hiển thị tất cả sản phẩm</label>
                            </div><!-- End .toolbox-item -->
